...
public class Lambda04 {
	...
	//List elemanlarinin tamamini buyuk harfli olarak, alfabetik sirada ve
	// tekrarli elemanlari sadece bir kere console'a yaz
	//Lambda Expression
	...
	// ters sirali olarak tekrarli elemanlari sadece bir kere olacak sekilde console'a yaz
	public static void charSayisiTersSiraliTekrarsiz(List<String> list) {
		list.stream().map(t->t.length()).sorted(Comparator.reverseOrder()).
				distinct().forEach(Lambda01::printEl);
	}
